...
interface NewOrderProps {
    clients: Client[];
    currentUserId: string; // <--- NOVA PROP OBRIGATÓRIA
    onSave: () => void;
    onCancel: () => void;
}

export const NewOrder: React.FC<NewOrderProps> = ({ clients, currentUserId, onSave, onCancel }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const serviceData: ServiceRecord = {
            ...
            ownerId: currentUserId, // <--- USA O ID RECEBIDO VIA PROP
    ...
    // Vou omitir o JSX visual para economizar espaço, pois ele não muda.
    // Apenas certifique-se de manter todo o return (...) que você já fez.
    ...
    return (
       // ... COLE SEU JSX ORIGINAL AQUI ...
       // Dica: Não mude nada no visual, ele está ótimo.
