...
export const ClientDetails: React.FC<ClientDetailsProps> = ({ client, currentUser, onBack }) => {
    ...
    const [isPaid, setIsPaid] = useState(false); // Adicionado status de pagamento no form
    ...
    const handleSaveService = async (e: React.FormEvent) => {
        ...
        const serviceData: ServiceRecord = {
            ...
            date: serviceDate,
            paid: editingServiceId ? isPaid : isPaid, // Usa o estado do form
    ...
    // CÁLCULO PADRONIZADO PARA O BOX DE TOTAIS DO FORMULÁRIO
