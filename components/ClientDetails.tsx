...
// --- Service Document Modal Component (EXPORTADO PARA CORRIGIR O ERRO) ---
...
export const ClientDetails: React.FC<ClientDetailsProps> = ({ client, currentUser, onBack }) => {
    ...
    const handleSaveService = async (e: React.FormEvent) => {
        ...
        const serviceData: ServiceRecord = {
            ...
            // status field removed from user input but kept internally as default if new
    ...
    const handleExportPDF = (type: 'client' | 'internal' = 'client') => {
        ...
        setTimeout(() => {
            try {
                ...
                // -- Table --
                // REMOVED Status Column from PDF
                ...
                autoTable(doc, {
                    ...
                    didParseCell: function (data: any) {
                        const statusColIndex = type === 'internal' ? 6 : 4; // Adjusted index
    ...
    // ... CSV Export (Updated to remove status column)
    const downloadCSV = () => {
        setShowExportMenu(false);
        ...
        const headers = ['Data', 'Solicitante', ...pickupHeaders, ...deliveryHeaders, 'Valor (R$)', 'Método', 'Pagamento']; // Removed Status
    ...
    // ... Excel Export (Updated to remove status column)
